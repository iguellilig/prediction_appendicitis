...
with col1:
    ...
    gender = st.radio("Sex",options=["Male", "Female"])
    height = st.text_input('Height: ', '')
    weight = st.text_input('Weight: ', '')
    appendix_diameter = st.text_input('Appendix_Diameter: ', '')
    migratory_pain = st.radio("Migratory_Pain",options=["Yes", "No"])
    lower_right_abd_pain = st.radio("Lower_Right_Abd_Pain",options=["Yes", "No"])
    contralateral_rebound_tenderness = st.radio("Contralateral_Rebound_Tenderness",options=["Yes", "No"])
    coughing_pain = st.radio("Coughing_Pain",options=["Yes", "No"])
    loss_of_appetite = migratory_pain = st.radio("Loss_of_Appetite",options=["Yes", "No"])
    ...
    neutrophilia = st.radio("Neutrophilia",options=["Yes", "No"])
with col2:
    ...
    ketones_in_urine = st.radio("Ketones_in_Urine",options=["No", "+", "++", "+++"])
    rbc_in_urine = st.radio("RBC_in_Urine",options=["No", "+", "++", "+++"])
    wbc_in_urine = st.radio("WBC_in_Urine",options=["No", "+", "++", "+++"])
    crp = st.text_input('CRP: ', '')
    dysuria = st.radio("Dysuria",options=["Yes", "No"])
    stool = st.radio("Stool",options=["Normal", "Constipation", "Diarrhea", "Constipation,Diarrhea"])
    peritonitis = st.radio("Peritonitis",options=["No", "Local", "Generalized"])
    psoas_sign = st.radio("Psoas_Sign",options=["Yes", "No"])
...
map = {'Male':0, 'Female':1, 'Normal': 7, 'Yes': 2, 'No':3, '+':4, '++':5, '+++':6, 'Constipation,Diarrhea':10, 'Constipation':8, 'Diarrhea':9, 'Local':11, 'Generalized':2}
